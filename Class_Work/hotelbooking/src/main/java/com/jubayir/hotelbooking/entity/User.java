...
public class User {
    ...
    @Size(min = 1, max = 50, message = "Character must be between 1 and 50")
    ...
    public User(@NotEmpty(message = "Enter your First Name") @Size(min = 1, max = 50, message = "Character must be between 1 and 50") String firstName, String lastName, String userName, String password, @NotEmpty @Email @NotEmpty(message = "Please Enter a valid Email Address") String email, String mobile, String gender, Date regiDate, Date lastModifiedDate, Date birthDate, boolean enabled, String confirmationToken, long fileSize, String fileName, String filePath, String fileExtension, Set<Role> roles) {
