...
public class User {
   ...
   private Set<Role> roles;
    ...
    public User(@NotEmpty(message = "Enter your First Name") @Size(min = 1, max = 50, message = "Character must be between 1 and 50") String firstName, String lastName, String userName, @NotEmpty @Email @NotEmpty(message = "Please Enter a valid Email Address") String email, Date birthDate, boolean enabled, String confirmationToken, Set<Role> roles) {
