...
public class UserControllerOld {
    ...
    public String saveUser() {
        ...
        User user = new User("Md.","Jubayir","Hossain","jubayir@gmail.com.com",new Date(),true, UUID.randomUUID().toString(),roles);
        user.setPassword(passwordEncoder.encode("Jubayir1234"));
        repo.save(user);
        return "success";
    }
